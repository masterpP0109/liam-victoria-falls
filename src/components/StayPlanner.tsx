      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full relative z-10">
        ...
        {isGenerating ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="space-y-6 animate-fade-in text-left">
                  ...
                  <form onSubmit={handleSubmitPlan} className="space-y-4 text-xs font-sans">
                    ...
                    <div className="pt-4 border-t border-[#E5E5E7] text-right">
                      <button
                        type="submit"
                        className="px-8 py-4 bg-[#4C248C] hover:bg-[#3B1C6E] text-white font-mono font-bold tracking-widest text-[9.5px] rounded-full shadow-sm active:scale-95 transition-all flex items-center space-x-2 ml-auto cursor-pointer"
                      >
              ...
              {state.step < 9 && (
                <div className="pt-6 border-t border-[#E5E5E7] flex items-center justify-between">
                  {state.step > 1 ? (
                    <button
                      onClick={prevStep}
                      className="px-5 py-2.5 font-mono text-[9.5px] font-bold tracking-widest text-[#5F5E6B] hover:text-[#4C248C] flex items-center space-x-1 border border-[#E5E5E7] rounded-full bg-white shadow-sm cursor-pointer active:scale-95 duration-150"
                    >
                  ...
                  <button
                    onClick={nextStep}
                    className="px-6 py-3 bg-[#4C248C] hover:bg-[#3B1C6E] text-white font-mono font-bold text-[9.5px] tracking-widest rounded-full flex items-center space-x-1 shadow-sm cursor-pointer active:scale-95 transition-transform"
                  >
            ...
            <aside className="lg:col-span-5 bg-[#F8F7F9] border border-[#E5E5E7] p-8 rounded-[36px] space-y-6 shadow-inner">
              <span className="font-mono text-[9px] tracking-widest text-[#4C248C] uppercase block border-b border-[#E5E5E7] pb-3.5 font-bold">
                DYNAMIC RETREAT ESTIMATE
              </span>

              {/* Accommodation detail item */}
              <div className="space-y-3">
                <span className="text-[9px] font-mono text-[#4C248C] font-bold block uppercase tracking-wider">Accommodations</span>
                {state.roomPreference ? (
                  <div className="bg-white p-4 rounded-xl border border-[#E5E5E7] flex items-center justify-between shadow-sm">
                    ...
                    <span className="font-mono text-xs font-bold text-[#4C248C] shrink-0">
              ...
              <div className="space-y-3">
                <span className="text-[9px] font-mono text-[#4C248C] font-bold block uppercase tracking-wider">Safari Itineraries</span>
                    ...
                    {state.experienceInterests.map((expId) => {
                      ...
                      return (
                        <div key={expId} className="bg-white p-3 rounded-lg border border-[#E5E5E7] flex items-center justify-between font-mono text-[10px] shadow-sm">
                          ...
                          <span className="text-[#4C248C] font-bold shrink-0">${exp.priceUSD * travellersCount}</span>
                        </div>
                      );
                    })}
                  </div>
              ...
              <div className="space-y-2">
                <span className="text-[9px] font-mono text-[#4C248C] font-bold block uppercase tracking-wider">Services Custom</span>
                <div className="space-y-1 font-mono text-[10px]">
                  ...
                  {state.guestPreferences.includes("private-guide") && (
                    <div className="flex items-center justify-between py-1.5 border-b border-[#E5E5E7]">
                      ...
                      <span className="text-[#4C248C] font-bold">+$ {150 * state.lengthOfStay}</span>
                    </div>
                  )}
                </div>
              </div>

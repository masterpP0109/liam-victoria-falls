...
export default function Location() {
  ...
  return (
    <section id="location" className="py-28 bg-white text-black relative border-b border-[#E5E5E7]">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20 text-left">
          <div className="space-y-4">
            <div className="inline-flex items-center space-x-1.5 text-[#4C248C] font-mono text-[9px] tracking-[0.25em] uppercase font-bold">
              <MapPin className="h-4.5 w-4.5 text-[#6D4EB3]" />
            ...
            <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl font-black text-black tracking-tight leading-none font-black font-serif">
              A Secluded Haven. <span className="text-[#4C248C] italic">Minutes Away</span>.
            </h2>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch mb-24 text-left">
          ...
          <div className="lg:col-span-7 bg-white rounded-[32px] border border-[#E5E5E7] p-8 flex flex-col justify-between shadow-md">
            <div className="space-y-8">
              <span className="font-mono text-[9px] tracking-widest text-[#4C248C] uppercase block font-bold">
              ...
              <div className="relative pt-6 pb-10 px-2">
                ...
                <div 
                  className="absolute top-[44px] left-8 h-[2px] bg-[#4C248C] transition-all duration-500 rounded"
                    ...
                    >
                      <div 
                        className={`h-9 w-9 rounded-full flex items-center justify-center border-2 transition-all shadow-sm relative z-10 ${
                          activePlace === idx 
                            ? "bg-[#4C248C] border-[#4C248C] text-white scale-110" 
                            : "bg-[#F8F7F9] border-[#E5E5E7] text-[#5F5E6B] group-hover:border-[#4C248C] group-hover:text-[#4C248C]"
                        }`}
                      >
              ...
              <div className="bg-[#F8F7F9] p-6 rounded-2xl border border-[#E5E5E7] space-y-3 shadow-inner">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2 text-[#5F5E6B] font-mono text-[9px] uppercase tracking-wider font-bold">
                    <Compass className="h-4 w-4 text-[#6D4EB3]" />
                    <span>TIMELINE NODE {activePlace + 1} • {PLACES[activePlace].distance}</span>
                  </div>
                  <span className="bg-[#4C248C] border border-[#DDD6FE]/30 text-white px-3.5 py-1 rounded-full text-[8.5px] font-mono uppercase font-bold tracking-widest">
            ...
            <div className="mt-8 pt-6 border-t border-[#E5E5E7]/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-[9.5px] font-mono text-[#5F5E6B] tracking-widest uppercase font-semibold">
              <span className="flex items-center space-x-1.5">
                <Info className="h-4 w-4 text-[#6D4EB3] shrink-0" />
              ...
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="text-[#4C248C] font-bold hover:underline flex items-center space-x-1"
              >
                <span>Google Maps</span>
                <ExternalLink className="h-3 w-3 text-[#6D4EB3]" />
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-8">
            <div className="bg-white border border-[#E5E5E7] p-8 rounded-[32px] space-y-4 h-full flex flex-col justify-center shadow-md">
              ...
              <div className="p-3.5 bg-[#F8F7F9] border border-[#E5E5E7] rounded-xl flex items-center space-x-2.5 font-mono text-[9px] text-[#4C248C] uppercase tracking-widest font-bold">
                <ShieldCheck className="h-4 w-4 text-[#6D4EB3] shrink-0" />
                <span>ALL AIRPORT LOGISTICS HANDLED</span>
              </div>
            </div>

            {/* Adjacent activities cards */}
            <div className="bg-[#F8F7F9] border border-[#E5E5E7] p-8 rounded-[32px] space-y-4 flex-1 flex flex-col justify-center shadow-inner">
              <h5 className="font-mono text-[9px] tracking-widest text-[#4C248C] uppercase font-bold">
              ...
              <div className="space-y-3.5 font-sans text-xs text-[#5F5E6B]">
                <div className="flex items-center justify-between pb-2 border-b border-[#E5E5E7]/65">
                  ...
                  <span className="text-[#4C248C] font-mono uppercase text-[9px] font-bold">Complimentary</span>
                </div>
                <div className="flex items-center justify-between pb-2 border-b border-[#E5E5E7]/65">
                  <span className="font-light">Local Tuk-Tuk Dispatches</span>
                  <span className="text-[#4C248C] font-mono uppercase text-[9px] font-bold">On Demand</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="font-light">Private Guided Sedans</span>
                  <span className="text-[#4C248C] font-mono uppercase text-[9px] font-bold">Pre-Schedules</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto pt-16 border-t border-[#E5E5E7]">
          <div className="text-center mb-12">
            ...
            <p className="text-xs text-[#4C248C] font-mono uppercase tracking-widest mt-3 font-semibold">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full px-6 py-5 flex items-center justify-between text-left hover:bg-[#F8F7F9] transition-colors cursor-pointer font-serif"
                  >
                    <span className="font-serif font-black text-sm text-black uppercase tracking-wide">
                      {faq.question}
                    </span>
                    {isOpen ? (
                      <ChevronUp className="h-4.5 w-4.5 text-[#6D4EB3] shrink-0 ml-3" />
                    ) : (
                      <ChevronDown className="h-4.5 w-4.5 text-[#6D4EB3] shrink-0 ml-3" />
                    )}
                  </button>
                  ...
                  <div 
                    className={`transition-all duration-300 ease-in-out px-6 overflow-hidden ${
                      isOpen ? "max-h-44 pb-5 opacity-100 mt-2 border-t border-[#F8F7F9] pt-4" : "max-h-0 opacity-0 pb-0"
                    }`}
                  >
